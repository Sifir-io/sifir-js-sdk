...
test.skip("Should be able to spend (will only run when testnet)", async t => {
  const {
...
/* Watch Pub32 tests */
test.skip("Should be able to get a list of watched Pub32 and their labels", async t => {
  const {
...
test.skip("Should be able to get a watched 32pub's balance by label", async t => {
  const {
...
test.skip("Should be able to get a watched 32pub's unused addresses", async t => {
  const {
...
test.skip("Should be able to get transactions for watch label ", async t => {
  const {
